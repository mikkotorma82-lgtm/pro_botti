...
def ensure_backfill(symbol: str, tf: str, days: int):
    # Jos data puuttuu, haetaan se backfillillä
...
def main():
    ...
    for tf in tfs:
        ...
        for sym in symbols:
            ...
            # Yritä rajata lookback aikaleiman mukaan, jos sarake löytyy
    ...
    # Pisteytys per symboli: pidetään paras TF
    ...
    dd_s = robust_rank_scale(dd, invert=True)  # pienempi drawdown parempi
